...
namespace MainApp
{
    ...
    {        
        ...
        public string recordDeductionDetails(SqlCommand cmd, int memberID, string transactionID, int currentRecord, int numOfRows, int errorflag, decimal  lstAllSavingsDeduction, decimal lstAllLoansDeduction, string repaymentLoanType,bool servicingLoan, bool loanMoreThanSavings)
        {
            ...
            strQuery = "Select MemberID,Amount,Remark from MemberSavingsTypeAcct where MemberID=@MemberID";
            cmd.CommandText = strQuery;
            ...
            strQuery = "Insert into DeductionDetails(DeductionID,DeductionType,Amount,Remarks,TransactionID)Values" +
               "(@DeductionID,@DeductionType,@Amount,@Remarks,@TransactionID)";
            ...
            else if ((lstAllLoansDeduction>0) && (lstAllSavingsDeduction == 0))
            {
                ...
                cmd.Parameters["@Remarks"].Value = "Savings have all been paid for loan repayment";
